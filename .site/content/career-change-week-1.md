...
author = ["James"]
date = 2026-01-02T19:33:00+00:00
draft = false
+++
...
### <span class="org-todo todo TODO">TODO</span> Learn SELinux ( Learn how to check logs and `audit2allow` ) {#learn-selinux--learn-how-to-check-logs-and-audit2allow}


### <span class="org-todo todo TODO">TODO</span> Learn `nmcli` {#learn-nmcli}
...
I was working on [installing and setting up a VM](/setting-up-vm-for-enterprise-environment/#components-for-the-stack) on my laptop which runs Arch Linux, using [QEMU](/qemu/#hardware-emulation) and [KVM](/kvm-kernel-based-virtual-machine/#what-is-it).
